...
function Calculator() {
  ...
  const handleMemoryChange = (memory) => {
    ...
    console.log(infoIphons[phoneModel].description);
  };

  const handleButtonClick = (buttonValue) => {};
  useEffect(() => {
    setRefundAmount(prices[phoneModel]?.[memorySize]?.["Сумма возврата"]);
  }, [memorySize]);
      ...
      <div className="wrapper-calculator">
        ...
        <div className="block-calculator">
          <div className="carousel-calculator">
            ...
            <div className="product-container">
              ...
              <div className="storage-label">Объем памяти</div>
              ...
              <div className="logo-aple">
                ...
                <p>{phoneModel}</p>
                <p>{memorySize}</p>
                <a href="#payment-main" className="price-formation price-formation-block">
                  Подробнее о формировании цены
                </a>
              </div>
              <div className="wrapper-price">
                    ...
                    type !== "Сумма возврата" && (
                      ...
                      >
                        ...
                        <div className="price-Tooltip">
                          <div className="price">
                            {parseInt(value).toLocaleString("ru-RU", {
                              style: "currency",
                              currency: "RUB",
                ...
                <div className="refund-amount2">
                  ...
                  <p>
                    <p>
                      {parseInt(refundAmount).toLocaleString("ru-RU", {
                        style: "currency",
                        currency: "RUB",
                        minimumFractionDigits: 0,
                        maximumFractionDigits: 0,
              ...
              <a href="#" className="price-formation price-formation-none">
                Подробнее о формировании цены
              </a>
        ...
        <div className="product-info">
          <div className="name-product">
            Технические характеристики {phoneModel} {memorySize}
          </div>
          <div className="unfurl-product" onClick={handleToggleInfo}>
            {isInfoVisible ? <img src={sv} alt="" /> : <img src={rv} alt="" />}
          </div>
          {isInfoVisible && (
            <div className="block-info-iphone">
              <div className="item">
                <p>Дисплей</p>
                <p>{infoIphons[phoneModel].display}</p>
              </div>
              <div className="item">
                <p>Чипсет</p>
                <p>{infoIphons[phoneModel].chipset}</p>
              </div>
              <div className="item">
                <p>Оперативная память</p>
                <p>{infoIphons[phoneModel].ram}</p>
              </div>
              <div className="item">
                <p>Накопитель</p>
                <p>{memorySize} NVMe</p>
              ...
              <div className="item">
                ...
                <p>{infoIphons[phoneModel].time}</p>
              </div>
              <div className="item">
                <p>Камеры</p>
                <p>{infoIphons[phoneModel].camera}</p>
              </div>
              <div className="item">
                <p>Подключения</p>
                <p>{infoIphons[phoneModel].connections}</p>
              </div>
              <div className="item">
                <p>Прочее</p>
                <p>{infoIphons[phoneModel].other}</p>
              </div>
              <div className="item">
                <p>Расцветки</p>
                <p>{infoIphons[phoneModel].colors}</p>
              </div>
            </div>
          )}
        </div>
