...
import iphone from "../images/iphone103.svg";
...
import man2 from "../images/man3.svg";
import bg from "../images/bgCompany.png";
  ...
  return (
    <div className="wrapper-Subscribe">
      <div className="main-container">
        <div className="bg">
          <img loading="lazy" src={logo} className="main-image" alt="Main" />
          <div className="subscribe-container">
            Подпишитесь на нашу группу в Telegram или WhatsApp
          </div>
          <div className="info-container">
            Чтобы следить за обновлениями и получать актуальную информацию о
            нашей продукции и магазине!
          </div>
          <div className="social-container">
            <a
              href="https://t.me/onestorerus"
              target="_blank"
        ...
        <div className="check-device-info">
          Как проверить устройство при получении?
        </div>
        <div className="video">
          <iframe
            width="560"
      ...
      <div className="subscribe-container">
        <div className="block-subscribe">
          <div className="title">Заказывайте Apple iPhone 15</div>
          <div className="discount-info">
            <div className="discount-label">
              из <img src={dubai} alt="" /> Дубая с кешбэком до
            </div>
            <div className="discount-percentage">
              <img src={p22} alt="" />
            </div>
          </div>
          <div className="warranty">и официальной гарантией – 1 год</div>

          <ModalOrder className="submit-button" toggle text="Оставить заявку" />
        </div>
        ...
        <div className="company-container">
          <div className="bg-company">
            <div className="block-company">
              ...
              <div className="company-description">
                ...
                >
                  Наша компания уже более 7 лет
                </span>
                <span
                  style={{ fontFamily: "Gilroy, sans-serif", fontWeight: 400 }}
                >
                  занимается продажей и сервисным обслуживанием техники Apple.
                  Мы закупаем и доставляем гаджеты из Дубая по системе Tax Free,
                  благодаря чему цены для наших покупателей в среднем на 30%
                  ниже, чем в популярных сетевых магазинах.
                </span>
              </div>
              <div className="company-location">
                ...
                >
                  Также вы всегда можете посетить наши магазины в Оренбурге
                </span>
                <span
                  style={{ fontFamily: "Gilroy, sans-serif", fontWeight: 500 }}
                >
                  и приобрести устройства или аксессуары из наличия. С
                  удовольствием поможем вам стать счастливым обладателем нового
                  iPhone по доступной цене!
                </span>
              </div>
            </div>
            <div className="block-company-img">
              <img className="man-big" src={man} alt="man" />
              <img className="man-small" src={man2} alt="" />
          ...
          <div className="company">
            <div className="company-facts company-item">
              ...
              <div className="year-founded">год основания компании</div>
            </div>
            <div className="company-warranty  company-item">
              <div className="warranty-period">1 год</div>
              <div className="warranty-info">официальная гарантия</div>
            </div>
            <div className="company-reviews  company-item">
              <div className="positive-reviews">&gt; 410</div>
              <div className="reviews-info">положительных отзывов</div>
            </div>
            <div className="order-stats  company-item">
              <div className="orders">&gt; 1050</div>
              <div className="orders-info">заказов за всё время</div>
            </div>
            <div className="company-locations  company-item">
              <div className="locations-number">2</div>
              <div className="locations-info">магазина в Оренбурге</div>
            </div>
            <div className="product-quality  company-item">
              <div className="quality-percentage">100%</div>
              <div className="quality-info">оригинальная продукция</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="how-working">
        ...
        <div className="item">
          ...
          <div className="text-block">
            <p className="text-main">Заявка или звонок</p>
            <p className="text">
              Вы отправляете нам сообщение через мессенджер, в соцсети,
              оставляете заявку на сайте или связываетесь по телефону
            </p>
          </div>
        </div>
        <div className="item">
          ...
          <div className="text-block">
            <p className="text-main">Согласование </p>
            <p className="text">
              Наш менеджер отвечает на ваш запрос, а также уточняет желаемый
              цвет и объём памяти смартфона, который вам нужен
            </p>
          </div>
        </div>
        <div className="item">
          ...
          <div className="text-block">
            <p className="text-main">Оформление заказа </p>
            <p className="text">
              Мы высылаем вам карту заказа для того, чтобы сверить информацию.
              Вы подтверждаете заказ, если всё указано верно
            </p>
          </div>
        </div>
        <div className="item">
          ...
          <div className="text-block">
            <p className="text-main">Предоплата от 20% </p>
            <p className="text">
              В зависимости от выбранной системы покупки (с TAX-Free или без) вы
              оплачиваете от 20 до 100% от суммы заказа
            </p>
          </div>
        </div>
        <div className="item">
          ...
          <div className="text-block">
            <p className="text-main">Оформление TAX-Free </p>
            <p className="text">
              Мы предоставим вам логин и пароль от личного кабинета на сайте
              оператора Global Blue, куда вам останется только ввести номер
              вашей карты и чек о покупке
            </p>
          </div>
        </div>
        <div className="item">
          ...
          <div className="text-block">
            <p className="text-main">Отправка </p>
            <p className="text">
              Мы вышлем заказ с одного из наших магазинов в Оренбурге (при этом
              можем предоставить видеоотчет с ТК) или же с Дубая, если заказ
              оформлен с кешбэком
            </p>
          </div>
        </div>
        <div className="item">
          ...
          <div className="text-block">
            <p className="text-main">Получение заказа </p>
            <p className="text">
              Вы получаете смартфон курьером или в отделении ТК, после чего
              сможете его проверить и оплатить оставшуюся часть суммы (если
        ...
        <div className="item">
          ...
          <div className="text-block">
            <p className="text-main"> Возврат TAX-Free</p>
            <p className="text">
              Если вы выбрали вариант оплаты с наибольшей скидкой, в течение 5 –
              7 дней с момента оплаты товара вы получите кешбэк в размере 22% от
              стоимости заказа
            </p>
          </div>
        </div>
        <div className="item">
          ...
          <div className="text-block">
            <p className="text-main">Эксплуатация и гарантия </p>
            <p className="text">
              Теперь вы стали счастливым обладателем смартфона от Apple, и
              можете обращаться к нам в случае возникновения гарантийных
              ситуаций!
            </p>
          </div>
        </div>
