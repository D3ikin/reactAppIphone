...
import bgOrder from "../images/bgOrder.png";
import bgOrder2 from "../images/bgOrder2.png";
...
function ModalOrder({ toggle = false, text, className, logo, id }) {
  ...
  const handleFormSubmit = async (phoneNumber) => {
    try {
      ...
      // Например, закрыть модальное окно
      handleOk();
    } catch (error) {
    ...
    <>
      ...
      >
        {toggle ? (
          ...
          <img className="bg-modal" src={bgOrder} alt="bg" />
        )}
        <div className="modal-wrapper">
          ...
          >
            Введите ваш номер, чтобы забрать бонусные 500 руб. на покупку
            техники Apple
          </p>
          <div className="modal-items">
            <div className="section-bonus">
              {toggle ? (
                ...
                <img src={iphoneBox} className="img-bonus" alt="iphoneBox" />
              )}
            </div>
            <div className="section-order">
              {toggle && <p className="submit-text">Оставить заявку</p>}
              {toggle ? (
                <p className="name-phone">Ваш номер телефона</p>
              ) : (
                <p className="name-phone">Введите ваш номер телефона</p>
              )}
              ...
              <div className="you-number">
                ...
                <EmailForm onNumberChange={handleNumberChange} onFormSubmit={handleFormSubmit}/>
              </div>
              {toggle ? (
                <SelectButton
                ...
                <button onClick={handleOk} className="confirm-bonus">
                  Получить 500 руб.
                </button>
              )}

              <div className="block-media">
                <p>Или напишите нам в мессенджер/соцсети:</p>
                <div className={`icon-media  ${toggle && "modal-application"}`}>
                  <a
                    href="https://www.instagram.com/onestore.delivery"
                    target="_blank"
                  >
                    <img src={instagram} alt="instagram" />
                  </a>
                  <a href="https://vk.com/onestore.shop" target="_blank">
                    <svg
                      width="35"
                      height="35"
                      viewBox="0 0 35 35"
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M17.5 35C27.165 35 35 27.165 35 17.5C35 7.83501 27.165 0 17.5 0C7.83501 0 0 7.83501 0 17.5C0 27.165 7.83501 35 17.5 35ZM24.3253 13.125C24.8719 13.125 24.986 13.4014 24.8719 13.7767H24.8712C24.6422 14.8101 22.4422 17.8529 22.4422 17.8529C22.2511 18.1534 22.1748 18.3039 22.4422 18.6415C22.5368 18.7713 22.7381 18.9649 22.9683 19.1863C23.2051 19.4141 23.4726 19.6713 23.6859 19.9189C24.4607 20.7762 25.0451 21.4987 25.2087 21.9965C25.3572 22.497 25.0987 22.75 24.5831 22.75H22.7784C22.2945 22.75 22.0511 22.484 21.5249 21.9089C21.302 21.6653 21.0284 21.3663 20.6644 21.0086C19.5932 19.9945 19.1347 19.8625 18.8666 19.8625C18.5029 19.8625 18.3942 19.9636 18.3942 20.4702V22.0604C18.3942 22.497 18.2526 22.75 17.1052 22.75C15.1919 22.75 13.0916 21.6094 11.5997 19.5057C9.36187 16.425 8.75 14.0957 8.75 13.6269C8.75 13.3636 8.85312 13.125 9.36875 13.125H11.1748C11.6361 13.125 11.8094 13.323 11.9806 13.8146C12.864 16.3404 14.3524 18.548 14.9643 18.548C15.1939 18.548 15.2991 18.4442 15.2991 17.8715V15.2604C15.2579 14.5173 14.9935 14.1958 14.7977 13.9577C14.6768 13.8108 14.5821 13.6956 14.5821 13.5327C14.5821 13.334 14.7546 13.125 15.0413 13.125H17.8793C18.2616 13.125 18.3881 13.3257 18.3881 13.7767V17.2892C18.3881 17.6652 18.5606 17.7966 18.6754 17.7966C18.9051 17.7966 19.0962 17.6652 19.5169 17.2514C20.817 15.8241 21.7348 13.6269 21.7348 13.6269C21.8496 13.3636 22.0614 13.125 22.5206 13.125H24.3253Z"
                        fill="#0077FF"
                      />
                    </svg>
                  </a>
                  <a href="https://wa.me/79014681604" target="_blank">
                    <svg
                      width="35"
                      height="35"
                      viewBox="0 0 35 35"
                  ...
                  <a href="https://t.me/onestorerus" target="_blank">
                    <svg
                      width="35"
                      height="35"
                      viewBox="0 0 35 35"
